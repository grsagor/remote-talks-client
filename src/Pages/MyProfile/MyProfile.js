			...
			<div className="grid grid-cols-1 md:grid-cols-2 gap-5 pb-24">
				<div className="w-full">
					<div className="flex justify-end bg-base-300">
						...
						<label
							htmlFor="my-modal-3"
							className="btn btn-outline btn-primary mt-4 mr-4 text-2xl"
						>
							<BiEdit></BiEdit>
						</label>
					</div>
					<div className="flex flex-col bg-base-300 items-center justify-center">
						...
						<div className="p-3 lg:p-6 text-center w-full">
							<div className="flex justify-between">
								<p className="text- font-semibold w-full text-center">Name </p>
								<span className="font-normal w-full text-start">
									: {data.name}
								</span>
							</div>
							<div className="flex justify-between">
								<p className="text- font-semibold w-full text-center">Email </p>
								<span className="font-normal w-full text-start">
									: {data.email}
								</span>
							</div>
							<div className="flex justify-between">
								<p className="text- font-semibold w-full text-center">
									Address{" "}
								</p>
								<span className="font-normal w-full text-start">
									: {data.address}
					...
					<div className="modal">
						<div className="modal-box relative modal-bg-color shadow-2xl">
							...
							<h3 className="text-lg font-bold">
								Update your profiles information
							</h3>
							{/* <p className="py-4">You've been selected for a chance to get one year of subscription to use Wikipedia for free!</p> */}
							<div>
								<form
									onSubmit={handleUpdateProfules}
								...
								>
									...
									{user?.email ? (
										<input
											className="btn btn-primary bg-green-700 hover:bg-warning text-white w-full"
											type="submit"
											value="Update Now"
										/>
									) : (
										<Link to="/login">
											<input
												...
												type="text"
												value="Please login before the Update"
											/>
										</Link>
									)}
								</form>
